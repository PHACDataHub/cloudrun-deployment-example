...
#Artifact Registry
ARTIFACT_REGISTRY_REPO=hello-world-app2
# Cloud SQL
INSTANCE_NAME=test-instance2
DB_NAME=test-db
DB_USER=test-user
# DB_PASSWORD=password123
DB_PASSWORD=$(openssl rand -base64 16 | tr -dc A-Za-z0-9 | head -c16 ; echo '')
#Cloud Build
CLOUD_BUILD_TRIGGER_NAME=django-from-scratch-trigger
GITHUB_REPO_NAME=cloudrun-deployment-example
CLOUD_BUILD_CONFIG_PATH=cloudbuild.yaml
GITHUB_REPO_OWNER=PHACDataHub
#Cloud Run 
SERVICE_NAME=hello-world-three 
SECRET_SETTINGS_NAME=django_settings2
